...
IconGlobe, IconDollarSign, IconPhoneCall, IconMenu, IconFacebook, IconInstagram, IconLinkedin, IconTwitter } from 'angular-feather';
const icons = [
  ...
  IconGlobe, IconDollarSign, IconPhoneCall, IconMenu, IconFacebook, IconInstagram, IconLinkedin, IconTwitter
]
@NgModule({
  imports: icons,
  exports:icons
